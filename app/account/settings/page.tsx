		...
		<div className="flex flex-col">
			...
			<div className="mt-5 *:p-3 bg-cardBG dark:bg-darkcardBG ring-border dark:ring-darkborder ring-1 shadow-lg rounded-lg">
				<div className="flex gap-4 items-center">
					<div >{AtSymbol}</div>
					<div className="text-sm text-nowrap overflow-x-auto">{username}</div>
				</div>
				<div className="flex gap-4 items-center">
					<div >{UserIcon}</div>
					<div className="text-sm  text-nowrap overflow-x-auto">{firstName}</div>
				</div>
			</div>
			...
			<div className="mt-5 *:p-3 bg-cardBG dark:bg-darkcardBG ring-border dark:ring-darkborder ring-1 shadow-lg rounded-lg">
				<button onClick={logOut} className="group flex gap-4 items-center ">
				...
				<button onClick={logOutAll} className="group flex items-center gap-4">
